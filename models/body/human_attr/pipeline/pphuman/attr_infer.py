...
class AttrDetector(Detector):
    ...
    def postprocess(self, inputs, result):
        ...
        lower_list = [
            '条纹下装',   # Stripe → 条纹下装 :contentReference[oaicite:3]{index=3}
            '图案下装',   # Pattern → 图案下装 :contentReference[oaicite:4]{index=4}
            '长款大衣',   # LongCoat → 长款大衣 :contentReference[oaicite:5]{index=5}
            '长裤',       # Trousers → 长裤 :contentReference[oaicite:6]{index=6}
            '短裤',       # Shorts → 短裤 :contentReference[oaicite:7]{index=7}
            '裙装'        # Skirt&Dress → 裙装 :contentReference[oaicite:8]{index=8}
        ]
        ...
        for res in im_results:
            ...
            label_res = []
            # gender 
            gender = '女' if res[22] > self.threshold else '男'
            ...
            bag_label = bag if bag_score > self.threshold else '无包'
            label_res.append(bag_label)
            # upper
            upper_label = '上衣:'
            sleeve = '长袖' if res[3] > res[2] else '短袖'
            ...
            # shoe
            shoe = '靴子' if res[14] > self.threshold else '非靴子'
